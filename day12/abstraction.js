let SCRIPTS = [
...

  {
    ...
    living: false,
    link: "https://en.wikipedia.org/wiki/Ancient_South_Arabian_s",
  },
  {
    name: "Saurashtra",
    ranges: [
  ...
  },
  {
    ...
    living: true,
    link: "https://en.wikipedia.org/wiki/%C5%9A%C4%81rad",
  },
  {
    name: "Siddham",
    ranges: [
  ...
  },
  {
    ...
    living: true,
    link: "https://en.wikipedia.org/wiki/Tai_Dam_language#Writin",
  },
  {
    name: "Telugu",
    ranges: [
  ...
  },
  {
    ...
    link: "https://en.wikipedia.org/wiki/Mongolian_writing_syste",
  },
];
...
function countBy(items, groupNameFunc) {
  ...
  for (let item of items) {
    ...
    let known = counts.findIndex((c) => c.name == name); // it is a test for the control flow statement below
...
// console.log(
//   countBy([1, 2, 2, 3, 4, 5], (n) => {
//     return 3 < n ? "greater" : "lesser";
//   })
// );
